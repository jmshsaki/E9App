...
RentacarModel rentacarModelFromJson(String str) =>
    RentacarModel.fromJson(json.decode(str));

String rentacarModelToJson(RentacarModel data) => json.encode(data.toJson());
...
class RentacarModel {
  ...
  factory RentacarModel.fromJson(Map<String, dynamic> json) => RentacarModel(
