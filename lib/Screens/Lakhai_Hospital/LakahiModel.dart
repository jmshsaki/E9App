...
LakahiModel LakahiModelFromJson(String str) =>
    LakahiModel.fromJson(json.decode(str));

String LakahiModelToJson(LakahiModel data) => json.encode(data.toJson());
...
class LakahiModel {
  ...
  factory LakahiModel.fromJson(Map<String, dynamic> json) => LakahiModel(
